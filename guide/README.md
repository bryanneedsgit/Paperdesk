...
Use this guide to understand what Paperdesk can do and where each feature lives in the app.

Paperdesk is an offline PDF workspace. It focuses on page-level editing, annotations, forms, formatting, and exporting local PDFs. It does not upload files and does not include OCR.
...
- [Keyboard Shortcuts](keyboard-shortcuts.md): supported keyboard shortcuts.
...
Original source PDFs are left unchanged unless you explicitly confirm overwriting one during export.
